    ...
    <div class="wrapper row">
        <div class="box-email">
            <div class="content">
                ...
                <br>
                <h3>SELAMAT DATANG DI MEMO.</h3>
                <p>Silahkan melakukan aktifasi akun kamu melalui link berikut </p><br>

                <a href="{{url('activate?token='.$user->remember_token)}}"
                    style="color: #fff;padding: 8px;background: #48c236;margin: auto;" target="_blank">AKTIVASI AKUN</a>
                <hr>
            ...
            <div class="footer">
                <div class="bottom">
                    <p>MEMO</p>
                    <p>© PT MEDIA SENTRAL ASIA - All Right Reserved 2021.</p>
                </div>
            </div>
        </div>
    </div>
